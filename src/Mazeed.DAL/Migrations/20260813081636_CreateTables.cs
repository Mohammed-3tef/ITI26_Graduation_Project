        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Orders_AspNetUsers_ShopperId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ShopperNotifications", x => new { x.ShopperId, x.NotificationId });
                    table.ForeignKey(
                        name: "FK_ShopperNotifications_AspNetUsers_ShopperId",
                        column: x => x.ShopperId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ShopperNotifications_Notifications_NotificationId",
                        column: x => x.NotificationId,
                        principalTable: "Notifications",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ItemReviews_AspNetUsers_ShopperId",
                        column: x => x.ShopperId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ShopperFavorites", x => new { x.ShopperId, x.ItemId });
                    table.ForeignKey(
                        name: "FK_ShopperFavorites_AspNetUsers_ShopperId",
                        column: x => x.ShopperId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ShopperCarts", x => new { x.ShopperId, x.ItemVariantId });
                    table.ForeignKey(
                        name: "FK_ShopperCarts_AspNetUsers_ShopperId",
                        column: x => x.ShopperId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ShopperNotifications_NotificationId",
                table: "ShopperNotifications",
                column: "NotificationId");
        }
